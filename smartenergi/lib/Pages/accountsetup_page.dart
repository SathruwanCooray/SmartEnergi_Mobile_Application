...
class ProfileSettingUpPage extends StatefulWidget {
  ...
  const ProfileSettingUpPage({Key? key, required this.userName}) : super(key: key);
...
class _ProfileSettingUpPageState extends State<ProfileSettingUpPage> {
  ...
  TextEditingController energyLimitController = TextEditingController(text: '1000');
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                actions: [
                                  ElevatedButton(
                                    onPressed: () {
                                      // Sample validation, replace with your logic
                                      if (hardwareIdController.text.isNotEmpty) {
                                        // Valid hardware ID
                                        // Add your logic here
